		...
		<div>
			...
			>
				...
				>
					...
					<div className="flex flex-col gap-1">
						<Item target="_blank" item={{ href: "https://github.com/DevNM/f1-dash", name: "Github" }} />
						<Item target="_blank" item={{ href: "https://discord.gg/unJwu66NuB", name: "Discord" }} />
						<Item target="_blank" item={{ href: "https://buymeacoffee.com/DevNM", name: "Buy me a coffee" }} />
						<Item target="_blank" item={{ href: "https://github.com/sponsors/DevNM", name: "Sponsor me" }} />
					</div>
				</nav>
			</motion.div>
		</div>
